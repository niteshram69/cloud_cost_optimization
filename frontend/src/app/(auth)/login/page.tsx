...
export default function LoginPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push(user.role === "ADMIN" ? "/admin" : "/dashboard/overview")
    } catch (err: unknown) {
      ...
      <div className="mt-10">
        <div>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link href="/reset-password" className="font-semibold text-brand-600 hover:text-brand-500">
                    Forgot password?
                  </Link>
                </div>
              </div>
            ...
            <div>
              <Button type="submit" className="w-full flex justify-center h-10">
        ...
        <div className="mt-10">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <Button variant="outline" className="w-full focus-visible:outline-offset-2">
